		...
		<div class="card">
			<div class="card-body">
				...
				<form method="post">
					...
					<p>
						Image: <input readonly="readonly" value="${product.image}"
					...
					<label for="quantity">Quantity:</label> <input type="number"
						...
						type="submit" value="Add To Cart" class="btn btn-success" />
				</form>
			</div>
		</div>
	</div>
		...
		<div class="card">
			<div class="card-body">
				...
				<form method="post">
					...
					<p>
						Reviews: <input name="reviews" class="form-control" />
					</p>

					<p>
						Ratings: <input name="ratings" class="form-control" />
					</p>
